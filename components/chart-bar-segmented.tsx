...
export const description = "A segmented bar chart showing calls by organization"
...
interface ChartBarSegmentedProps {
  calls: CallWithOrg[]
  timeRange: string
  groupBy: 'day' | 'hour'
...
export function ChartBarSegmented({
  calls,
  timeRange,
  groupBy,
  onTimeRangeChange,
  ...
  const { processChartData, chartConfig, organizations } = React.useMemo(() => {
    ...
    // Group calls by date and organization
    ...
    filteredCalls.forEach(call => {
      ...
      dateData[call.organization_slug] = (dateData[call.organization_slug] || 0) + 1
    })
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        <CardTitle>Call Volume by Organization</CardTitle>
        <CardDescription>
