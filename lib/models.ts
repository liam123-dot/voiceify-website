...
export const LLM_MODELS: LLMModel[] = [
  ...
  },
  {
    ...
    description: 'Latest GPT-4 generation',
    features: ['Latest generation', 'High capability'],
  },
  {
  ...
  },
  {
    ...
    description: 'Ultra-efficient GPT-4.1 model',
    features: ['Very affordable', 'Fast response'],
  },
  {
    id: 'openai/gpt-5',
    name: 'GPT-5',
  ...
  },
  {
    ...
    features: ['Next-gen efficiency', 'Fast'],
  },
  {
    ...
    outputPricePerMillion: 0.40,
    cachedInputPricePerMillion: 0.025,
    description: 'Ultra-efficient GPT-5 model',
    features: ['Ultra-affordable', 'Fast response'],
  },
  // Google Gemini Models
  {
    ...
    features: ['High capability', 'Multimodal', 'Long context'],
  },
  {
    ...
    features: ['Fast', 'Balanced cost', 'Good quality'],
  },
  {
    ...
    features: ['Very affordable', 'Fast', 'Efficient'],
  },
  {
    ...
    features: ['Cost-effective', 'Proven performance'],
  },
  {
    ...
    cachedInputPricePerMillion: 0.0175,
    description: 'Most affordable Gemini model',
    features: ['Most affordable', 'Fast', 'Lightweight'],
  },
  // Other Models
  {
    ...
    description: 'Qwen large language model',
    features: ['Large context', 'Instruction following'],
  },
  {
    ...
    outputPricePerMillion: 2.50,
    description: 'Kimi instruction-following model',
    features: ['Instruction optimized', 'Task completion'],
  },
  {
    ...
    features: ['Reasoning', 'Code generation', 'Balanced pricing'],
  },
];
